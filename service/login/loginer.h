...
public:
	...
	virtual ~Loginer();
	int processLogin(const string& userName, const string& passWord, int sendToClientFd, int& logoutFd, int& code, string& msg);
	int processLogout(const string& userName, int& code, string& msg);
